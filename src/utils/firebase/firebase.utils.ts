...
import { getAuth, signInWithRedirect, signInWithPopup, GoogleAuthProvider, createUserWithEmailAndPassword,
    signInWithEmailAndPassword, signOut, onAuthStateChanged, User, NextOrObserver } from 'firebase/auth';
...
export const getCategoriesAndDocuments = async (): Promise<Category[]> => {
    ...
    return queryShapshot.docs.map((docShapshot) => docShapshot.data() as Category);
};
